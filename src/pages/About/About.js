...
export default function About() {
  ...
  <p className="about__card__content--text">Our team is multi-disciplinary and we are not merely interested in form — content and meaning 
  ...
  <p className="about__card__content--text">We are visual storytellers in appealing and captivating ways. By combining business and marketing strategies, 
