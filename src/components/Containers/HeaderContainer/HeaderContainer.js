    ...
    function HeaderMenu()  {
           return (
            ...
            <nav  className="header__menu__nav">
                    <Link to="/"><h3 className="header__menu__nav--title">OUR COMPANY</h3></Link>
                    <Link to="/locations"><h3 className="header__menu__nav--title">LOCATIONS</h3></Link>
                    <Link to="/contact"><h3 className="header__menu__nav--title">CONTACT</h3></Link>
            </nav>
            </motion.div>
           )
